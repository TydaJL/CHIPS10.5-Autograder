...
When ('I click on state {string}') do |string|
  visit "state/#{string}"
end
...
When ('I follow News Articles for Biden') do
...
When("I select the first article to rate") do |title|
    choose "selected_news_#0"
end